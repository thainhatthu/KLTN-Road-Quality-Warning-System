...
export default function FullMapScreen() {
  ...
  const handleRoute = async () => {
    ...
    const url = `https://94a7-42-116-6-46.ngrok-free.app/osrm/route/v1/driving/${fromCoord.lng},${fromCoord.lat};${to.coord.lng},${to.coord.lat}?alternatives=true&overview=full&geometries=geojson`;
