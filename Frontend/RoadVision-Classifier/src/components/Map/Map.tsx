    ...
    geocoder.geocode(startLocation, (startRes: any[]) => {
      ...
      geocoder.geocode(endLocation, async (endRes: any[]) => {
        ...
        const res = await fetch(
          `http://192.168.120.179:5000/route/v1/driving/${s.lng},${s.lat};${e.lng},${e.lat}?alternatives=true&overview=full&steps=true&geometries=geojson`
        );
        ...
        const routingCtrl = L.Routing.control({
          ...
          router: L.Routing.osrmv1({
            serviceUrl: "http://192.168.120.179:5000/route/v1",
          }),
