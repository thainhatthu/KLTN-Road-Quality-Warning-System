    ...
    geocoder.geocode(startLocation, (startRes: any[]) => {
      ...
      geocoder.geocode(endLocation, async (endRes: any[]) => {
        ...
        const res = await fetch(
          `https://b151-42-116-6-46.ngrok-free.app:5000/route/v1/driving/${s.lng},${s.lat};${e.lng},${e.lat}?alternatives=true&overview=full&steps=true&geometries=geojson`
        );
        ...
        const routingCtrl = L.Routing.control({
          ...
          router: L.Routing.osrmv1({
            serviceUrl: "https://b151-42-116-6-46.ngrok-free.app:5000/route/v1",
          }),
